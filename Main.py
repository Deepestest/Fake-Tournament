...
for matchNumber in matchCSV["Match Number"]:
    numMatches += 1
for matchNumber in matchCSV["Match Number"]:
    print("Simulating Match " + str(matchNumber))
    ...
    ActualMatchJson["score_breakdown"]["red"]["endGameBridgeState"] = redEndgameLevel
    ActualMatchJson["score_breakdown"]["red"]["endGameParkPoints"] = redParkingPoints
    ActualMatchJson["score_breakdown"]["blue"][
        "endGameChargeStationPoints"
    ] = blueTeleDockPoints
    ActualMatchJson["score_breakdown"]["blue"]["endGameBridgeState"] = blueEndgameLevel
    ActualMatchJson["score_breakdown"]["blue"]["endGameParkPoints"] = blueParkingPoints
    ...
    ActualMatchJson["score_breakdown"]["red"]["autoCommunity"]["B"] = redAutoPlacements[
        0
    ]
    ActualMatchJson["score_breakdown"]["red"]["autoCommunity"]["M"] = redAutoPlacements[
        1
    ]
    ActualMatchJson["score_breakdown"]["red"]["autoCommunity"]["T"] = redAutoPlacements[
        2
    ]
    ...
    ActualMatchJson["score_breakdown"]["red"]["autoMobilityPoints"] = redMobilityPoints
    ...
    blueAutoPoints = blueAutoGamePiecePoints + blueAutoDockPoints + blueMobilityPoints
